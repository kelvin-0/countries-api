    ...
    return (
        <form className="mb-6 flex items-center w-full md:w-5/12 md:inline-block md:float-left">   
            <div className="relative w-full">
                ...
                <input type="text" id="search" className="bg-gray-50 shadow-md text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for a country..." required/>
            </div>
        </form>
    )
}
